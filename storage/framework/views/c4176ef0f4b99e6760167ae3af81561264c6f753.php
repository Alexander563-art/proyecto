...
<head>
    ...
    <title>Fenix | Sistem Ventas</title>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?php echo e(route('logout')); ?>" class="btn btn-default btn-flat">Cerrar</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo e(url('almacen/categoria')); ?>"><i class="fa fa-circle-o"></i> Categorías</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo e(url('compras/proveedor')); ?>"><i class="fa fa-circle-o"></i> Proveedores</a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
...
<?php /**PATH C:\xampp\htdocs\cursolaravel\sisVentas\resources\views/layouts/admin.blade.php ENDPATH**/ ?>